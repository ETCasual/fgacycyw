...
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_4__.cleanupOutdatedCaches)(); // Cache start url
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_3__.registerRoute)(/\.(?:jpg|jpeg|gif|png|svg|ico|webp)$/i, new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.NetworkFirst({
...
'GET'); // const handler = async ({ event }) => {
//   const dontFollowRedirects = new Request(event.request.url, { redirect: 'manual' });
//   const response = await fetch(dontFollowRedirects);
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_3__.setCatchHandler)(function (_ref) {
  ...
  switch (event.request.destination) {
    case 'document':
      ...
      return (0,workbox_precaching__WEBPACK_IMPORTED_MODULE_4__.matchPrecache)('/_offline');
