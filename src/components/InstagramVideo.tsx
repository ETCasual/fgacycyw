	...
	return (
		<>
			<blockquote
				...
				data-instgrm-permalink="https://www.instagram.com/tv/CTUQ3f_ACqW/?utm_source=ig_embed&utm_campaign=loading"
			...
			>
				<div style={{ padding: '16px' }}>
					{' '}
					<a
						href="https://www.instagram.com/tv/CTUQ3f_ACqW/?utm_source=ig_embed&utm_campaign=loading"
						style={{
							background: '#FFFFFF',
							lineHeight: 0,
							padding: '0 0',
